# 📚 Clipboard Bridge Documentation
...
We welcome documentation improvements and translations!

- **English**: Native speakers help improve clarity
- **Chinese**: 中文母语者帮助改进表达
- **Japanese**: 日本語ネイティブの協力を歓迎
- **Other Languages**: Add new language directories

See [Contributing Guide](./en/contributing.md) for details.
